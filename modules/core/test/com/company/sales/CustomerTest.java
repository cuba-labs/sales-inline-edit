...
import com.company.sales.global.MyDataLoader;
...
public class CustomerTest {
    ...
    @Test
    public void testMyDataLoader() throws Exception {
        MyDataLoader myDataLoader = AppBeans.get(MyDataLoader.class);
        Customer customer = myDataLoader.loadCustomer(UUID.randomUUID());
